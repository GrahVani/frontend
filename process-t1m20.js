...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-20';
const interactiveDir = 'src/components/learning-runtime/interactive';

const comps = [
  "bhrigu-flow",
  "evidentiary-layers",
  "reader-due-diligence",
  "nadi-honest-handling-instance",
  "agastya-flow",
  "nadi-verification-sandbox",
  "nadi-decision-framework",
  "sublineage-map",
  "nadi-discipline-statement-builder",
  "nadi-commercial-explorer",
  "manuscript-material-map",
  "school-comparator",
  "matching-protocol-flow",
  "stream-position-map",
  "grantha-accessibility-map",
  "session-flow",
  "kanda-map",
  "shloka-decoder"
];
