...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-12';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-12
    const inModule12 = fs.existsSync(path.join(moduleDir, componentName));
