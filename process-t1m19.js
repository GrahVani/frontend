...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-19';
const interactiveDir = 'src/components/learning-runtime/interactive';

const comps = [
  "tajika-cross-stream-synthesis",
  "tajika-muntha-concept-explorer",
  "tajika-varshesha-selector",
  "tajika-ithasala-explorer",
  "tajika-honest-handling",
  "tajika-saham-concept-explorer",
  "tajika-three-yoga-comparator",
  "tajika-varshaphala-caster",
  "tajika-prashna-concept-explorer",
  "m19-closure",
  "tajika-auspicious-sahams-comparator",
  "tajika-varshaphala-synthesizer",
  "tajika-prashna-judgment-methodology",
  "tajika-twelve-yogas-surveyor",
  "tajika-life-event-sahams-surveyor",
  "tajika-vs-kp-horary-comparator",
  "tajika-origins-timeline",
  "tajika-yogas-application-wizard",
  "tajika-sahams-application-wizard",
  "tajika-neelakanthi-structure",
  "tajika-texts-catalogue",
  "tajika-comparative-matrix"
];
