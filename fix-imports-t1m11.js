...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-11';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-11
    const inModule11 = fs.existsSync(path.join(moduleDir, componentName));
