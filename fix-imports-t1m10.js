...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-10';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-10
    const inModule10 = fs.existsSync(path.join(moduleDir, componentName));
