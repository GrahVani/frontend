...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-8';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-8
    const inModule8 = fs.existsSync(path.join(moduleDir, componentName));
