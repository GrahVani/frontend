...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-15';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-15
    const inModule15 = fs.existsSync(path.join(moduleDir, componentName));
