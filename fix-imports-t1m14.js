...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-14';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-14
    const inModule14 = fs.existsSync(path.join(moduleDir, componentName));
