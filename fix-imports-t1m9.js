...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-9';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-9
    const inModule9 = fs.existsSync(path.join(moduleDir, componentName));
