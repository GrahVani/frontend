...
// Event → weekday verdicts per lesson §4.4 ("most favourable" = best,
// "acceptable" = good, "avoid" = avoid). Benefic lords (Guru/Śukra) head the
// auspicious onsets; malefic lords (Maṅgala/Śani, and the mild-malefic Sūrya
// for marriage) head the avoid lists.
const EVENTS: EventCategory[] = [
  {
    key: "marriage",
    label: "Marriage",
    best: ["Thursday (Guru)", "Friday (Śukra)"],
    good: ["Monday (Candra)", "Wednesday (Budha)"],
    avoid: ["Tuesday (Maṅgala)", "Saturday (Śani)", "Sunday (Sūrya)*"],
    reasoning: "Jupiter (Guru, dharma/prosperity) and Venus (Śukra, union/beauty) are prime; Mars brings conflict, Saturn delays. *Sunday is region-dependent — accepted in some traditions, avoided in others.",
  },
  {
    key: "business",
    label: "Business start",
    best: ["Wednesday (Budha)", "Thursday (Guru)"],
    good: ["Friday (Śukra)", "Monday (Candra)"],
    avoid: ["Tuesday (Maṅgala)", "Saturday (Śani)"],
    reasoning: "Mercury (Budha) governs commerce/accounts; Jupiter (Guru) brings expansion. Mars conflicts and Saturn causes losses/delay.",
  },
  {
    key: "education",
    label: "Education (Vidyārambha)",
    best: ["Wednesday (Budha)", "Thursday (Guru)"],
    good: ["Monday (Candra)", "Friday (Śukra)"],
    avoid: ["Tuesday (Maṅgala)", "Saturday (Śani)"],
    reasoning: "Mercury (Budha) is learning and Jupiter (Guru) is wisdom — the two education lords. Mars distracts and Saturn obstructs.",
  },
  {
    key: "foundation",
    label: "Foundation (Gṛhārambha)",
    best: ["Monday (Candra)", "Wednesday (Budha)", "Thursday (Guru)", "Friday (Śukra)", "Saturday (Śani)"],
    good: ["Sunday (Sūrya)"],
    avoid: ["Tuesday (Maṅgala)"],
    reasoning: "Foundation tolerates most lords — even Saturn (Śani), whose endurance suits durable/long-term structures. Only Mars (Maṅgala), bringing fire and conflict, is avoided.",
  },
  {
    key: "surgery",
    label: "Surgery",
    best: ["Tuesday (Maṅgala)"],
    good: ["Sunday (Sūrya)", "Wednesday (Budha)"],
    avoid: ["Monday (Candra)", "Friday (Śukra)"],
    reasoning: "Mars (Maṅgala) rules the blade, cutting, and surgical action — its day is best for surgery. Moon (fluids) and Venus (soft tissue) days are avoided.",
  },
  {
    key: "spiritual",
    label: "Spiritual onset",
    best: ["Thursday (Guru)", "Monday (Candra)"],
    good: ["Wednesday (Budha)", "Friday (Śukra)"],
    avoid: ["Tuesday (Maṅgala)", "Saturday (Śani)"],
    reasoning: "Jupiter (Guru, dharma) and Moon (Candra, devotion) head spiritual onsets. Mars is too aggressive and Saturn too obstructive for an auspicious spiritual start.",
  },
  {
    key: "journey",
    label: "Journey",
    best: ["Choose by direction (Dik-Śūla)"],
    good: [],
    avoid: ["East → Sun, Mon", "South → Tue, Wed", "West → Thu", "North → Fri, Sat"],
    reasoning: "Journeys are judged by Dik-Śūla ('the thorn of the quarter'), not a flat weekday ranking: each weekday blocks one direction. Avoid setting out toward the blocked direction on that day — East on Sun/Mon, South on Tue/Wed, West on Thu, North on Fri/Sat (Muhūrta Cintāmaṇi, Yātrāprakaraṇa).",
  },
];

const VARA_GRID = [
  { day: "Sunday", dev: "रवि", lord: "Sūrya", symbol: "☉", quality: "Mild malefic", best: ["Leadership", "Government", "Sūrya worship"], avoid: ["Marriage", "Surgery"], color: "#E8B845" },
  { day: "Monday", dev: "सोम", lord: "Candra", symbol: "☽", quality: "Gentle", best: ["Healing", "Water work", "Gentle onset"], avoid: ["Confrontation"], color: "#7A8CB8" },
  { day: "Tuesday", dev: "मङ्गल", lord: "Maṅgala", symbol: "♂", quality: "Malefic", best: ["Surgery", "Property", "Martial training"], avoid: ["Marriage", "Education", "Auspicious onset"], color: "#C8412E" },
  { day: "Wednesday", dev: "बुध", lord: "Budha", symbol: "☿", quality: "Balanced", best: ["Education", "Business", "Contracts"], avoid: ["Martial / conflict"], color: "#3A8C5A" },
  { day: "Thursday", dev: "गुरु", lord: "Guru", symbol: "♃", quality: "Great benefic", best: ["Marriage", "Religious onset", "Study"], avoid: ["Austerity work"], color: "#E89E2A" },
  { day: "Friday", dev: "शुक्र", lord: "Śukra", symbol: "♀", quality: "Benefic", best: ["Marriage", "Arts / music", "Vehicles / jewellery"], avoid: ["Ascetic acts"], color: "#5A8CC8" },
  { day: "Saturday", dev: "शनि", lord: "Śani", symbol: "♄", quality: "Malefic", best: ["Foundation", "Industry / iron", "Long-term work"], avoid: ["Marriage", "Auspicious onset"], color: "#5A5A7A" },
];
