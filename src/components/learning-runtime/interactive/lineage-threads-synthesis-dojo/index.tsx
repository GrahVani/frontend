...
import { COMPARISON_ROWS, DRILL_SCENARIOS } from "./data";
...
export function LineageThreadsSynthesisDojo() {
    ...
    <div>
      <div className="overflow-x-auto">
        <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "4px" }}>
          <thead>
            <tr>
              {["Lineage", "Founder", "Regional school", "Streams", "Infrastructure", "Reach"].map((h) => (
                <th
                  key={h}
                  style={{
                    padding: "8px 6px",
                  ...
                  <td style={{ padding: "8px 6px" }}>
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: "6px",
                        border: "none",
                        background: isExpanded ? "rgba(156,122,47,0.10)" : "transparent",
                        color: isExpanded ? "#9C7A2F" : INK_PRIMARY,
                        fontFamily: "var(--font-sans), system-ui, sans-serif",
                        fontSize: "13px",
                        fontWeight: 600,
                        cursor: "pointer",
      ...
      >
        Click any lineage name to highlight its row. All eight lineages are real-and-substantive; none displaces another.
      </p>
    </div>
  );
}
