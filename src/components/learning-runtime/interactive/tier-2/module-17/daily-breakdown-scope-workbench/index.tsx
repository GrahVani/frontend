        ...
        <>
          <div style={workbenchDiagramLayoutStyle}>
            <section style={{ ...cardStyle, flex: "2 1 460px" }}>
              ...
              <svg viewBox="0 0 600 300" role="img" aria-label="Two independent arguments converging on scope restriction" style={{ width: "100%", maxHeight: 380, margin: "0.4rem auto 0.75rem", display: "block" }}>
                <rect x="20" y="20" width="560" height="260" rx="8" fill={GOLD_TINT} stroke={HAIRLINE} />

                <rect x="44" y="44" width="164" height="72" rx="8" fill={epistemicOn ? BLUE_TINT : MUTED_TINT} stroke={epistemicOn ? BLUE : INK_MUTED} strokeWidth="2" />
                ...
                <rect x="392" y="44" width="164" height="72" rx="8" fill={ethicalOn ? PURPLE_TINT : MUTED_TINT} stroke={ethicalOn ? PURPLE : INK_MUTED} strokeWidth="2" />
                <text x="474" y="72" textAnchor="middle" fill={ethicalOn ? PURPLE : INK_MUTED} fontSize="13" fontWeight={700}>Ethical</text>
                <text x="474" y="92" textAnchor="middle" fill={ethicalOn ? INK_PRIMARY : INK_MUTED} fontSize="11" fontWeight={600}>Frequency amplifies</text>
                <text x="474" y="108" textAnchor="middle" fill={ethicalOn ? INK_PRIMARY : INK_MUTED} fontSize="11" fontWeight={600}>risk profile</text>

                {epistemicOn && (
                  <path d="M 126 116 C 126 170, 215 196, 260 214" fill="none" stroke={BLUE} strokeWidth="4" strokeLinecap="round" />
                )}
                {ethicalOn && (
                  <path d="M 474 116 C 474 170, 385 196, 340 214" fill="none" stroke={PURPLE} strokeWidth="4" strokeLinecap="round" />
                )}

                <rect x="206" y="212" width="188" height="58" rx="8" fill={epistemicOn || ethicalOn ? GREEN_TINT : MUTED_TINT} stroke={epistemicOn || ethicalOn ? GREEN : INK_MUTED} strokeWidth="3" />
                <text x="300" y="234" textAnchor="middle" fill={epistemicOn || ethicalOn ? GREEN : INK_MUTED} fontSize="12" fontWeight={700}>Scope restriction</text>
                <text x="300" y="250" textAnchor="middle" fill={epistemicOn || ethicalOn ? INK_PRIMARY : INK_MUTED} fontSize="9.5" fontWeight={600}>Reserved for high-stakes</text>
                <text x="300" y="263" textAnchor="middle" fill={epistemicOn || ethicalOn ? INK_PRIMARY : INK_MUTED} fontSize="9.5" fontWeight={600}>occasional use</text>
              </svg>
          ...
          <section style={cardStyle}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                ...
                <div style={{ width: "120px", height: "8px", borderRadius: "999px", background: GOLD_TINT, overflow: "hidden" }}>
            ...
            {SCENARIOS.map((scenario) => {
              ...
              return (
                <section key={scenario.id} style={{ ...cardStyle, borderLeft: `4px solid ${showFeedback ? (isCorrect ? GREEN : VERMILION) : HAIRLINE}` }}>
                  ...
                  {showFeedback && (
                    <div style={{ marginTop: "0.75rem", padding: "0.65rem 0.85rem", borderRadius: "8px", background: isCorrect ? GREEN_TINT : VERMILION_TINT, border: `1px solid ${isCorrect ? GREEN : VERMILION}` }}>
        ...
        <>
          <div style={workbenchTwoColumnStyle}>
              ...
              <div style={{ display: "grid", gap: "0.55rem", marginTop: "0.75rem" }}>
                {SCENARIOS.map((scenario) => (
                  <button
                    ...
                    style={{ textAlign: "left", padding: "0.75rem", borderRadius: "8px", border: `1.5px solid ${selectedScenario === scenario.id ? (scenario.classification === "in-scope" ? GREEN : VERMILION) : HAIRLINE}`, background: selectedScenario === scenario.id ? (scenario.classification === "in-scope" ? GREEN_TINT : VERMILION_TINT) : SURFACE, cursor: "pointer" }}
                  >
            ...
            <section style={{ ...cardStyle, borderLeft: `4px solid ${selected.classification === "in-scope" ? GREEN : VERMILION}` }}>
              ...
              <div style={{ marginTop: "0.85rem", padding: "0.55rem 0.75rem", borderRadius: "8px", background: GOLD_TINT, border: `1px solid ${GOLD}` }}>
                <p style={{ margin: 0, color: INK_MUTED, fontSize: "0.82rem", lineHeight: 1.5 }}>
      ...
      <span style={{ display: "grid", gap: "0.35rem" }}>
        ...
        {active && (
          <span style={{ display: "flex", alignItems: "center", gap: "0.65rem", marginTop: "0.25rem" }}>
            ...
            <span style={{ flex: 1, height: "10px", borderRadius: "999px", background: tintForColor(color), overflow: "hidden" }}>
