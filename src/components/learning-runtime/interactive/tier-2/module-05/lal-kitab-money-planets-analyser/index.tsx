...
export function LalKitabMoneyPlanetsAnalyser() {
  ...
  // Evaluate aspects
  const { channelActive, correctAspectKey, phrasingText } = useMemo(() => {
    let active = false;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-6">
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="p-4 rounded-xl border bg-white shadow-sm space-y-4" style={{ borderColor: HAIRLINE }}>
            ...
            {/* Mars House */}
            <div>
              <label className="block text-[10px] uppercase font-bold mb-1" style={{ color: LABEL_TEXT }}>Mars House:</label>
              <select
                value={marsHouse}
            ...
            {/* Mercury House */}
            <div>
              <label className="block text-[10px] uppercase font-bold mb-1" style={{ color: LABEL_TEXT }}>Mercury House:</label>
              <select
                value={mercHouse}
            ...
            {/* Venus House */}
            <div>
              <label className="block text-[10px] uppercase font-bold mb-1" style={{ color: LABEL_TEXT }}>Venus House:</label>
              <select
                value={venHouse}
