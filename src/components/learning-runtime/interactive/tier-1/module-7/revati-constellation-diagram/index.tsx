...
import { 
  ...
  Heart, Feather, Waves, Sun, RefreshCw, Compass
} from "lucide-react";
...
const ICON_MAP: Record<string, React.ReactNode> = {
  ...
  "Compass": <Compass size={18} strokeWidth={2.5} />,
};
...
const ICON_COLORS: Record<string, string> = {
  ...
  "Waves": "#2A8C9F", // Teal
  "Sparkles": "#D9B02E", // Yellow/Gold
  "Sun": "#D97A2E", // Orange
  "RefreshCw": "#3A8C5A", // Green
  "Compass": "#4F6FA8", // Blue
};

export function RevatiConstellationDiagram() {
  ...
  return (
    <div
      ...
      data-interactive="revati-constellation-diagram"
    >
      <div role="tablist" aria-label="Synthesis modes" style={{ display: "flex", gap: "10px", marginBottom: "18px", flexWrap: "wrap" }}>
        ...
        <TabButton
          ...
          label="Nourisher Drill"
          sublabel="2 evaluation scenarios"
                ...
                <svg width="100%" height="100%" viewBox="-260 -260 520 520" style={{ overflow: "visible" }}>
                  ...
                  {centerNode && (
                    ...
                    >
                      ...
                      <text textAnchor="middle" dy="-2" fontSize="30" fontWeight="bold" fill="#FFF" pointerEvents="none">
                        {centerNode.devanagari}
                      </text>
                      <text textAnchor="middle" dy="22" fontSize="16" fontWeight="500" fill="rgba(255,255,255,0.95)" pointerEvents="none">
                        {centerNode.iast}
                      </text>
                    </g>
                  )}
