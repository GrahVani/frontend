...
export function PurvaAshadhaRelationshipMap() {
  ...
  return (
    <div
      ...
      data-interactive="purva-ashadha-relationship-map"
    >
      <div role="tablist" aria-label="Synthesis modes" style={{ display: "flex", gap: "10px", marginBottom: "18px", flexWrap: "wrap" }}>
        <TabButton
          active={tab === "diagram"}
          onClick={() => setTab("diagram")}
          label="Radial Relationship Map"
          sublabel="Emphasizes attribute connections"
          icon={<Sparkles size={14} />}
        />
        <TabButton
          active={tab === "drill"}
          onClick={() => setTab("drill")}
          label="Invincibility Drill"
            ...
            <g style={reducedMotion ? {} : { 
              ...
              return (
                <g key={node.id}>
                  ...
                  >
                    <g style={reducedMotion ? {} : {
                      animation: 'slowCounterOrbit 60s linear infinite',
                      animationPlayState: isHovering ? 'paused' : 'running',
                      transformOrigin: '0px 0px'
                    }}>
                      <motion.circle 
