...
export const DAY_TYPES: DayType[] = [
  ...
  },
  {
    ...
    duration: "~30 sāvana days",
    durationSec: 2592000,
    scope: "Solar-month calendars, saṅkrānti festivals, Tājika annual-return, saṁhitā cycles",
    detail:
...
export const FLASHCARDS: Flashcard[] = [
  ...
  },
  {
    ...
    front: "Saura / Solar",
    frontDevanagari: "सौर",
    back: "Saṅkrānti → next saṅkrānti (~30 sāvana days)",
    backDetail: "Solar calendars, saṅkrānti festivals, Tājika annual-return",
    color: JADE,
    dayTypeKey: "solar",
  },
  {
