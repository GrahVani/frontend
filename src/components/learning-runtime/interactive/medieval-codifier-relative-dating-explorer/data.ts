...
export const MEDIEVAL_CODIFIERS: MedievalCodifier[] = [
  {
    ...
    englishLabel: "The Garland of Essence",
  ...
  },
  {
    ...
    curriculumCites: "T1-08 (Yogas — extended catalogue), T1-14 (Predictive Synthesis), T2 advanced use-cases",
    color: "#4F6FA8",
    colorDeep: "#2F4778",
  },
  {
