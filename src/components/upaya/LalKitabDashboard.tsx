...
export default function LalKitabDashboard({ data, className }: LalKitabDashboardProps) {
    ...
    return (
        <div className={cn(
            ...
            {/* Premium Header */}
            <div className="shrink-0 bg-gradient-to-b from-border-warm to-divider p-4 border-b-2 border-border-warm relative">
            ...
            <div className="shrink-0 px-4 pb-6 pt-2 bg-gradient-to-t from-border-warm to-surface-warm relative">
                {/* Subtle Texture */}
