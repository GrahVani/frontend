...
export default function LalKitabDashboard({ data, className }: LalKitabDashboardProps) {
    ...
    return (
        <div className={cn(
            "h-full max-h-[85vh] rounded-[2rem] bg-surface-warm border-4 border-divider shadow-2xl flex flex-col overflow-hidden relative",
            className
        )}>
            ...
            {/* Premium Header */}
            <div className="shrink-0 bg-gradient-to-b from-border-warm to-divider p-5 border-b-2 border-border-warm relative">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="p-3 bg-surface-warm rounded-xl border border-parchment-soft/30">
                                        <p className="text-[10px] font-bold text-muted-refined mb-1 uppercase">Positive</p>
            ...
            <div className="shrink-0 px-8 pb-10 pt-2 bg-gradient-to-t from-border-warm to-surface-warm relative">
                {/* Subtle Texture */}
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="flex items-center gap-4 group cursor-default">
                            <div className="p-2.5 bg-white/60 rounded-xl border-2 border-divider/50 group-hover:border-accent-gold transition-colors shadow-sm">
                                <Sun className="w-5 h-5 text-accent-gold" />
                            </div>
                            <div className="flex-1">
                                <p className="text-accent-gold font-black text-[10px] uppercase tracking-wider mb-0.5">Rule 1</p>
                        ...
                        <div className="flex items-center gap-4 group cursor-default">
                            ...
                            <div className="flex-1">
                                <p className="text-accent-gold font-black text-[10px] uppercase tracking-wider mb-0.5">Rule 2</p>
                        ...
                        <div className="flex items-center gap-4 group cursor-default">
                            ...
                            <div className="flex-1">
                                <p className="text-accent-gold font-black text-[10px] uppercase tracking-wider mb-0.5">Rule 3</p>
