            ...
            <div className="space-y-3">
                ...
                >
                    <div className="flex items-center gap-4">
                        <button className="w-12 h-12 rounded-full flex items-center justify-center transition-all shadow-sm border bg-amber-500 text-white border-amber-600" aria-label={`Play ${currentDasha} Mahadasha mantra`}>
                ...
                {topRecommendation && (
                    ...
                    >
                        <div className="flex items-center gap-4">
                            <button className="w-12 h-12 rounded-full flex items-center justify-center transition-all shadow-sm border bg-white text-amber-600 border-antique/30" aria-label={`Play ${topRecommendation.planet} recommended mantra`}>
