...
export default function KpDashaViewer({ className }: KpDashaViewerProps) {
    ...
    return (
        <div className={cn("w-full flex flex-col overflow-hidden rounded-lg border border-gold-primary/15 bg-white shadow-sm h-full", className)}>
            {/* Card Header + Breadcrumbs */}
            <div className="bg-gold-primary/10 px-3 py-1.5 border-b border-gold-primary/15 shrink-0 flex items-center justify-between gap-3">
                <h3 className={cn(TYPOGRAPHY.value, "text-[14px] text-ink font-semibold leading-tight tracking-wide !mb-0 text-balance shrink-0")}>
                    Vimshottari Dasha
                </h3>
                ...
                <table className="w-full border-collapse table-fixed">
                    <thead className="sticky top-0 z-20 bg-surface-warm/95 backdrop-blur-sm shadow-sm">
                        <tr className={cn("border-b border-gold-primary/10", TYPOGRAPHY.tableHeader)}>
                            <th className="px-1.5 py-1 text-left w-[30%]">
                                {currentLevelName}
                            </th>
                            <th className="px-1.5 py-1 text-left w-[25%]">Start</th>
                            <th className="px-1.5 py-1 text-left w-[25%]">End</th>
                            <th className="px-1.5 py-1 text-left w-[20%]">Dur</th>
                        </tr>
                    </thead>
