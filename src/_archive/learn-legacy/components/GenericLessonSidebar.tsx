...
interface GenericLessonSidebarProps {
...
export default function GenericLessonSidebar({
  sections,
  activeSection,
  completedSections,
  onNavigate,
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] text-gray-500 leading-snug italic">
            {progress === 0
              ...
              : progress < 25
              ? "Great start! The journey of a thousand miles…"
              : progress < 50
              ? "You're building momentum. Keep going!"
              : progress < 75
              ? "More than halfway! You're doing amazing."
              : progress < 100
              ? "Almost there! Final push to mastery."
              : "Lesson complete! You've unlocked new wisdom."}
          </p>
        </div>
      </div>
    </div>
