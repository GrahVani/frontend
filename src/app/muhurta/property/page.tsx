...
export default function PropertyMuhurtaPage() {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <MuhurtaFilters category="property" onSearch={handleSearch} loading={isLoading} />
            ...
            {isLoading ? (
                ...
                <EmptyState
                    ...
                    description="Try expanding your date range or adjusting the location for property purchase dates."
                />
            ) : (
                <EmptyState
                    icon={Home}
                    title="Search for property dates"
                    description="Enter a date range and location above to find auspicious dates for property transactions."
                />
            )}
        </div>
    );
