...
import { Clock, Sun, Moon, AlertTriangle, Sparkles } from "lucide-react";
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <span className="text-sm font-serif font-semibold text-ink">06:32 AM</span>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <span className="text-sm font-serif font-semibold text-ink">06:18 PM</span>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <Moon className="w-5 h-5 text-gold-primary" />
                                <div>
                                    <span className="text-xs text-muted-refined block">Moonrise</span>
                                    <span className="text-sm font-serif font-semibold text-ink">03:15 PM</span>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <Moon className="w-5 h-5 text-gold-dark" />
                                <div>
                                    <span className="text-xs text-muted-refined block">Moonset</span>
                                    <span className="text-sm font-serif font-semibold text-ink">03:42 AM</span>
                                </div>
                            </div>
                        </div>
                    </div>
