...
export default function ChaldeanError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    captureException(error, {
      tags: { boundary: 'route', section: 'chaldean-numerology' },
    ...
    <div className="flex items-center justify-center min-h-[60vh] px-4">
      <div className="max-w-md w-full text-center space-y-6" role="alert">
        ...
        <h2 className="text-[20px] font-serif text-amber-900">
          Chaldean Analysis Error
        </h2>
        <p className="text-amber-800/70 text-[14px]">
          Unable to perform the numerological calculation. Please try again.
        </p>
        <button
          onClick={reset}
