...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-7';
...
for (const file of files) {
  ...
  while ((match = regex.exec(content)) !== null) {
    ...
    // Check if it exists in module-7
    const inModule7 = fs.existsSync(path.join(moduleDir, componentName));
