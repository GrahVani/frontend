...
const moduleDir = 'src/components/learning-runtime/interactive/tier-1/module-23';
...
const comps = Array.from(new Set([
  ...
  "vara-lord-effects-explorer",
  "bhadra-avoidance-integrator",
  "panchaka-cancellation",
  "muhurta-concept-scope",
  "vivaha-muhurta-evaluator",
  "muhurta-honest-handling",
  "lagna-suddhi-evaluator",
  "muhurta-decision-framework",
  "nakshatras-categorized-explorer",
  "panchanga-five-limb-framework",
  "four-pillar-integrator",
  "pada-calculator",
  "griha-pravesha-muhurta-evaluator",
  "rahu-kala-yamaganda-explorer",
  "m23-closure",
  "muhurta-text-corpus-navigator",
  "yatra-muhurta-evaluator",
  "muhurta-comparative-position-explorer",
  "choghadiya-rahukalam-calculator"
]));
